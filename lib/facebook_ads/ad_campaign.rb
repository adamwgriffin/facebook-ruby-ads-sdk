...
module FacebookAds
  ...
  class AdCampaign < Base
    ...
    def create_ad_set(name:, promoted_object: {}, targeting:, daily_budget: nil, lifetime_budgetL nil, end_time: nil, optimization_goal:, billing_event: 'IMPRESSIONS', status: 'ACTIVE', is_autobid: nil, bid_amount: nil)
